    ...
    stage('Deploy Production') {
      ...
      steps{
        ...
        // Change deployed image in canary to the one we just built
          sh("sed -i.bak 's#gcr.io/iamotis/java-app:v1#${IMAGE_TAG}#' /home/phu_xv97/java-app/java-app/k8s/production/*.yaml")
    ...
    stage('Deploy Dev') {
      ...
      steps {
        container('kubectl') {
          ...
          sh("sed -i.bak 's#gcr.io/iamotis/java-app:v1#${IMAGE_TAG}#' /home/phu_xv97/java-app/java-app/k8s/dev/*.yaml")
